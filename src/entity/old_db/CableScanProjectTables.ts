...
@Entity("cableScanProject_tables", { schema: "dev_linksdb" })
export class CableScanProjectTables {
  @PrimaryGeneratedColumn({ type: "int", name: "id" })
  id: number;

  @Column("varchar", { name: "scanProjectName", nullable: true, length: 255 })
  ...
  @ManyToOne(
    () => CableTables,
    (cableTables) => cableTables.cableScanProjectTables,
